...
function ChatWindow({
    ...
    const sendMessage = useCallback(
        ...
        [messages, isLoading, locale, t, setMessages]
    );
...
export function ChatBot({ headless = false }: { headless?: boolean }) {
    ...
    // Ensure any previously persisted keys in browser storage are completely cleared
    useEffect(() => {
        try {
    ...
    // Listen for external toggle events (e.g. from Hero)
    useEffect(() => {
