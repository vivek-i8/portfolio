...
import { ChevronDown, Navigation, Briefcase, Rocket, FileText, Github, Mail } from 'lucide-react';
...
function MegaBoxBig({ href, icon: Icon, title, desc, theme, pathname }: NavBoxProps) {
    ...
    return (
        <Link href={href} className={cn(
            ...
            <div className="relative z-10 mt-auto">
                ...
                <p className={cn("text-xs font-normal leading-relaxed transition-colors duration-300", theme === 'dark' ? "text-white/60 group-hover:text-white/80" : "text-black/60 group-hover:text-black/80")}>{desc}</p>
            </div>
...
function MegaBoxSmall({ href, icon: Icon, title, desc, theme, pathname }: NavBoxProps) {
    const isActive = pathname === href || pathname?.startsWith(`${href}/`);
        ...
        <Link href={href} className={cn(
            ...
            <div className="flex items-start justify-between relative z-10">
                <div>
                    ...
                    <p className={cn("text-[11px] font-normal leading-relaxed transition-colors duration-300", theme === 'dark' ? "text-white/60 group-hover:text-white/80" : "text-black/60 group-hover:text-black/80")}>{desc}</p>
                </div>
...
function SidebarLink({ href, icon: Icon, title, desc, theme, pathname }: NavBoxProps) {
    ...
    const content = (
        <>
            <div className="flex-1 relative z-10">
                ...
                <p className={cn("text-[11px] font-normal transition-colors duration-300", theme === 'dark' ? "text-white/60 group-hover:text-white/80" : "text-black/60 group-hover:text-black/80")}>{desc}</p>
            </div>
...
export default function CardNav({
    ...
    const isActive = useMemo(() => {
        const hrefs = ['/projects', '/experience', '/skills', '/resume', '/contact', '/github'];
                    ...
                    >
                        <div className={cn(
                            ...
                            <div className="flex-1 p-5 flex flex-col gap-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <MegaBoxSmall href="/skills" icon={Navigation} title="Skills" desc="Tech stack & expertise" theme={theme} pathname={pathname} />
                                    <MegaBoxSmall href="/resume" icon={FileText} title="Resume" desc="View or download my CV" theme={theme} pathname={pathname} />
                                </div>
                            </div>
