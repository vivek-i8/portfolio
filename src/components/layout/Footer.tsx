    ...
    return (
        <>
            ...
            <footer className={cn(
                ...
                <div className={`max-w-[1600px] mx-auto relative z-10 px-6 md:px-12 lg:px-24 py-6 md:py-8 pointer-events-auto`}>
                    <div className={`px-6 md:px-8 py-4 md:py-6 transition-all duration-300 glass-card`}>
                            ...
                            <div className="flex-1 flex flex-col px-[8vw] pt-[4vh] pb-0 justify-between relative">
                                ...
                                <div className="mt-auto overflow-hidden flex-shrink-0 relative">
                                    <motion.h2
                                        ...
                                        className="text-[11.5vw] whitespace-nowrap font-black leading-none text-zinc-900 dark:text-white tracking-tighter select-none text-center"
                                    >
                                        VIVEK KUMAWAT
                                    </motion.h2>
                                </div>
