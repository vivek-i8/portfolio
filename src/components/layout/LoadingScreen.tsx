...
import { AppleHelloEnglishEffect } from '@/components/effects/AppleHelloEffect';
        ...
        <AnimatePresence mode="wait">
            {isLoading && (
                ...
                >
                    ...
                    >
                        <AppleHelloEnglishEffect speed={0.6} onAnimationComplete={handleAnimationComplete} className="text-foreground h-16 sm:h-20 md:h-24 will-change-transform" />
                    </motion.div>
