...
// Version-pinned worker; the legacy build has the broadest browser support.
...
function Component({ url }: { url: string }) {
  ...
  return (
    ...
    >
      <div className="hidden md:flex flex-col p-4 items-center border-r border-border bg-background overflow-y-auto no-scrollbar max-w-[200px] shrink-0">
