    ...
    >
      ...
      <main className="relative flex-1 flex flex-col justify-center pt-40 pb-20 z-10 max-w-[105rem] w-full mx-auto">
        <div className="flex relative gap-4 px-6 md:items-center w-full flex-col justify-center">
          ...
          <div className="md:flex gap-8 items-center relative">
            ...
            >
              Hi, I'm Vivek. I build AI systems and software that ships.
            </motion.p>
            ...
            <div className="relative">
              ...
              >
                ...
                <div
                  ...
                  onMouseEnter={(e) => setTooltip({ show: true, text: "Talk to my AI Assistant", icon: 'zap', x: e.clientX, y: e.clientY })}
          ...
          <div className="md:flex gap-8 items-center relative">
            ...
            >
              Open to internships and collaboration, remote or on-site.
            </motion.p>
          </div>
        </div>
      ...
      >
        ...
        <div className="relative z-50">
          <motion.div
            whileHover={{ x: 10 }}
            className="bg-white text-black py-8 px-4 text-[10px] font-black uppercase tracking-[0.4em] shadow-2xl rounded-r-3xl border-r border-y border-zinc-200 cursor-pointer"
          >
          ...
          {showProfile && (
            ...
            >
              <ProfileCard
                ...
                description={`${personal.name} builds AI systems and the software around them: training and shipping models, then wiring them into products people actually use.`}
