...
const INITIAL_CHIPS = [
  ...
  },
  {
    ...
    description: "From interface to backend",
    icon: Layers,
  },
];
      ...
      >
        ...
        >
          ...
          <defs>
            ...
            >
              <stop stopColor="currentColor" className="text-black dark:text-white" stopOpacity="0.4" />
              <stop offset="1" stopColor="currentColor" className="text-black dark:text-white" stopOpacity="0.2" />
            </linearGradient>
          </defs>
        </svg>
        ...
        >
          <g filter="url(#filter0_i_51_65)">
            <path
              ...
              className="fill-zinc-200 dark:fill-card"
            />
          </g>
