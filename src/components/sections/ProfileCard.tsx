  ...
  return (
    <div className={cn("w-full max-w-7xl mx-auto px-4 relative", className)}>
      ...
      <div className='hidden md:flex relative items-center'>
        {/* Square Image - only rendered when imageUrl is provided */}
        {imageUrl && (
        ...
        <motion.div
          ...
          className={`bg-white dark:bg-[#161616] rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.1)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.5)] p-10 ${imageUrl ? 'ml-[-100px]' : 'ml-0'} z-10 w-[600px] border border-black/5 dark:border-white/5 flex flex-col justify-center`}
        >
          <div className='mb-6'>
      ...
      >
        {/* Square Mobile Image - only rendered when imageUrl is provided */}
        {imageUrl && (
