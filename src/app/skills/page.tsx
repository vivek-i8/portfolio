...
import { SplineScene } from '@/components/skills/SplineScene';
import { KineticTechGrid } from '@/components/skills/KineticTechGrid';
import { ArchedTechIconsInteractive } from '@/components/skills/ArchedTechIcons';
import { SoftSkillsCarousel } from '@/components/skills/SoftSkillsCarousel';
import { HardSkills } from '@/components/skills/HardSkills';
import { TechStackSection } from '@/components/skills/TechStackSection';
import FeatureSection from '@/components/skills/StackFeatureSection';
...
const techLogos: Record<string, string> = {
    ...
    'LangGraph': '/skills/langgraph.svg',
...
function Bubble({ b, mouseX, mouseY }: { b: TechBubble; mouseX: MotionValue<number>; mouseY: MotionValue<number> }) {
    const ref = useRef<HTMLDivElement>(null);
    const [center, setCenter] = useState({ x: 0, y: 0 });
    // Randomised once per bubble so re-renders don't restart the float animation.
...
function FloatingTechBubbles({ mouseX, mouseY }: { mouseX: MotionValue<number>; mouseY: MotionValue<number> }) {
    const bubbles = [
        ...
        { icon: "redis", top: "62%", left: "18%", delay: 2.4 },
        { icon: "fastapi", top: "78%", left: "10%", delay: 1.1 },

        // RIGHT SIDE (Mixed AI & Software)
        { icon: "nextjs", top: "18%", right: "12%", delay: 0.4 },
        { icon: "docker", top: "35%", right: "22%", delay: 1.8 },
        { icon: "typescript", top: "52%", right: "10%", delay: 1.3 },
        { icon: "opencv", top: "68%", right: "24%", delay: 2.8 },
